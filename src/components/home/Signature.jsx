...
export default function Signature() {
  return (
    <section
      ...
      className={`relative w-full min-h-[60vh] bg-no-repeat bg-top-left md:bg-center bg-cover overflow-hidden`}
    >
      <div className="absolute inset-0 bg-linear-to-r from-black via-black/50 to-transparent" />
      <div className="page-container">
        <div className="text-amber-50 h-full absolute p-12 flex flex-col items-center text-center sm:text-left sm:items-start justify-center gap-4 ">
          <span className="eyebrow">NEW — THE NOCTURNE COLLECTION</span>
          <h2 className="md:max-w-full lg:max-w-5xl">

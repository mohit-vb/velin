  ...
  return (
    <section className="section">
      ...
      <div className="page-container">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-8 md:p-16 my-16">
          {featuredCollection.map(({ id, perfumeName, perfumeImg }) => (
            <figure className="relative group overflow-hidden h-72" key={id}>
              ...
              />
              <figcaption className="absolute w-[80%] text-balance left-1/2 bottom-4 -translate-x-1/2 text-amber-50 bg-stone-950/20 px-2 sm:px-4 text-base sm:text-xl font-bold">
                {perfumeName}
              </figcaption>
            </figure>
          ))}

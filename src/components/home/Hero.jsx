...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-black via-black/60 sm:via-black/80 to-transparent">
        &nbsp;
      </div>
      <div className="relative page-container">
        <div className="relative z-10 min-h-screen text-amber-50 flex flex-col items-start justify-center gap-8">
